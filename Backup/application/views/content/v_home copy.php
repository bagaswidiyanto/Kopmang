<div class="menu-populer" id="popular-menu" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <div class="col-lg-11 position-relative">
                        <div class="box-bg">
                            ...
                            <div class="order-now text-center mt-2 mb-2">
                                ...
                                <a href="https://wa.wizard.id/dc559b" target="_blank"
                                    class="btn-wa py-2 px-3 shadow-none m-2"><i class="fa fa-whatsapp"></i>
                                    0812-5615-5624</a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container menu-container">
        <div class="row justify-content-center">
            <div class="col-lg-11" data-aos="fade-up" data-aos-duration="2000">
                ...
                <div class="order-now text-center mt-4 mb-2">
                    <h2>PESAN SEKARANG</h2>
                    <a href="https://wa.wizard.id/dc559b" target="_blank" class="btn-wa py-2 px-3 shadow-none m-2"><i
