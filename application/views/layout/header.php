    ...
    <div class="container-xxl bg-white p-0">
        <div class="container-xxl position-relative p-0" id="home">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <div class="container">
                    <a class="navbar-brand hid fw-bold order-1 flex-grow-1" href="<?= base_url(); ?>"><img
                    ...
                    <div class="collapse navbar-collapse w-lg-auto order-3 order-lg-0 mt-3" id="navbarNav">
                        ...
                        <a class="navbar-brand fw-bold order-1 flex-grow-1" href="<?= base_url(); ?>"><img
                                src="https://admin103.kopmang.com/upload/<?= $website->image; ?>" class="img-fluid"
                                alt=""></a>
            ...
            <div class="container-xxl hero-header d-flex align-items-center justify-content-center">
                <div class="container">
                    <div class="row justify-content-center text-center ">
                        <div class="col-lg-6">
                            <h1 class="text-white mb-4" data-aos="fade-down" data-aos-duration="500">
                                <?= $homeweb->title; ?></h1>
                            <p class="text-white pb-3" data-aos="fade-up" data-aos-duration="500">
                                "<?= $homeweb->deskripsi; ?>”</p>
                            <div class="position-relative w-100 mt-3" data-aos="zoom-in" data-aos-duration="500">
